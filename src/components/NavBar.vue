  ...
  <div>
    <nav class="border-gray-200 bg-[#f8f9fa] dark:bg-[#262c30]">
      <div class="mx-auto flex max-w-screen-xl flex-wrap items-center justify-between p-6">
        ...
        <div
          class="animate-showMenu hidden w-full origin-top md:block md:w-auto md:animate-none"
          id="navbar-default"
          ref="navbar"
        >
          <ul
            class="mt-4 flex flex-col rounded-lg bg-gray-50 p-4 font-medium md:mt-0 md:flex-row md:space-x-8 md:bg-[#f8f9fa] md:p-0 rtl:space-x-reverse dark:bg-[#262c30] md:dark:bg-[#262c30]"
          >
            <li>
              <a
                href="#"
                class="block rounded px-3 py-2 text-[#7c7c7d] md:bg-transparent md:p-0 md:text-[#7c7c7d] dark:text-[#d3d2d2]"
                aria-current="page"
                >about</a
              >
            </li>
            <li>
              <a
                href="#"
                class="block rounded px-3 py-2 text-[#7c7c7d] hover:bg-gray-100 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-black dark:text-[#d3d2d2] dark:hover:text-[#d3d2d2] md:dark:hover:bg-transparent md:dark:hover:text-white"
                >skills</a
              >
            </li>
            <li>
            ...
            <li>
              <a
                href="#"
                @click="toggleDark()"
                class="block rounded px-3 py-2 text-[#4f4f52] hover:bg-gray-100 md:border-0 md:p-0 md:hover:bg-transparent md:hover:text-black dark:text-[#d3d2d2] dark:hover:text-[#d3d2d2] md:dark:hover:bg-transparent md:dark:hover:text-white"
                ><i
                  :class="{
